 ...
 */
final class Version20220916081819 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fiche_frais (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, nb_justificatifs INT NOT NULL, date_modif DATE NOT NULL, mois DATE NOT NULL, montant NUMERIC(10, 0) NOT NULL, INDEX IDX_5FC0A6A7A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
